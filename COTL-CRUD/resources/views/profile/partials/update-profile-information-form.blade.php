<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            <x-input-label for="name" :value="__('Name')" class="text-purple-300 uppercase text-xs" />
        ...
        <div>
            <x-input-label for="email" :value="__('Email')" class="text-purple-300 uppercase text-xs" />
            ...
            <div>
                <p class="text-sm mt-2 text-red-400">
                    ...
                    <button form="send-verification" class="underline text-sm text-gray-400 hover:text-purple-400 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500">
                        {{ __('Click here to re-send the verification email.') }}
                    </button>
                </p>

                @if (session('status') === 'verification-link-sent')
                <p class="mt-2 font-medium text-sm text-green-400 uppercase tracking-wide">
